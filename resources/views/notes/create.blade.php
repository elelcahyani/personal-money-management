...
<div class="max-w-2xl mx-auto">
    <div class="mb-8">
        <h1 class="text-4xl font-bold text-gold mb-2">Tambah Catatan</h1>
        ...
        <form method="POST" action="{{ route('notes.store') }}">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="title" value="{{ old('title') }}" 
                    ...
                    placeholder="Contoh: Rencana Investasi, Tips Hemat" required>
                @error('title')
            ...
            <div class="mb-8">
                ...
                <div id="noteContent" contenteditable="true"
                    class="w-full px-4 py-3 bg-dark-gray border border-gold border-t-0 text-silver rounded-b-lg focus:outline-none focus:ring-2 focus:ring-gold transition leading-relaxed min-h-[300px] max-h-[500px] overflow-y-auto"
                    data-placeholder="Tulis catatan keuanganmu di sini...">{{ old('content') }}</div>
